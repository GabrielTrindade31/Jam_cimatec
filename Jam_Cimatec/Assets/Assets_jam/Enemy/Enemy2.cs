...
public class Enemy2 : MonoBehaviour
{
    ...
    void PlayWalkAnimation(Vector2 vel)
    {
        ...
        {
            if (vel.x > 0) animator.Play("WalkRight2");
            else           animator.Play("WalkLeft2");
        }
        else
        {
            if (vel.y > 0) animator.Play("WalkUp2");
            else           animator.Play("WalkDown2");
        }
    }
    ...
    void PlayAttackAnimation(Vector2 dir)
    {
        ...
        {
            if (dir.x > 0) animator.Play("AttackRight2");
            else           animator.Play("AttackLeft2");
        }
        else
        {
            if (dir.y > 0) animator.Play("AttackUp2");
            else           animator.Play("AttackDown2");
        }
    }
